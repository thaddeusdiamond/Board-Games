  ...
  namespace SampleGames {
    ...
    class Gomoku : public Games::Game {
     public:
       ...
       **/
      explicit Gomoku() :
          game_state_(PLAYER_ONE_TURN), turn_number_(0), player_(PLAYER_ONE) {
        // Game specific data
        ...
        PLAYER_COLOR[PLAYER_ONE] = "#000";
        PLAYER_COLOR[PLAYER_TWO] = "#FFF";
     ...
     private:
      ...
      /**
       * We represent how many turns have been taken so that we can write
       * that to the game board.
       **/
      int turn_number_;
